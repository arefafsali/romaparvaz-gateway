...
export class ZagrosController extends BaseRouter {
  manager: ZagrosManager;
  constructor() {
    super(ZagrosManager);
    this.init();
  }
...
const zagrosController = new ZagrosController();
export default zagrosController.router;